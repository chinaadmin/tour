...
.factory('allDrawS', function($http,httpRequest){
	return {
		getAwardContent:function (data,callback) {
			httpRequest.post(interfaceURL.luckyDraw.getAwardContent,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		draw:function (data,callback) {
			httpRequest.post(interfaceURL.luckyDraw.draw,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		myDrawLis:function (data,callback) {
			httpRequest.post(interfaceURL.luckyDraw.myDrawLis,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		getMyDraw:function (data,callback) {
			httpRequest.post(interfaceURL.luckyDraw.getMyDraw,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		addAddress:function (data,callback) {
			httpRequest.post(interfaceURL.luckyDraw.addAddress,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		showMyAddress:function (data,callback) {
			httpRequest.post(interfaceURL.luckyDraw.showMyAddress,data).success(function (data) {
				callback&&callback(data)				
			})
		}
	}
