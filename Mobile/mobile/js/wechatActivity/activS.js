...
.factory('activS', function($http,httpRequest){
		return {
				getMyList:function (data,callback) {
					httpRequest.post(interfaceURL.activitys.myList,data).success(function (data) {
						callback&&callback(data)				
					})
				},
				getSysList:function (data,callback) {
					httpRequest.post(interfaceURL.activitys.sysList,data).success(function (data) {
						callback&&callback(data)				
					})
				},
				...
				getContent:function(data,callback){
					httpRequest.post(interfaceURL.activitys.notice,data).success(function (data) {
						callback&&callback(data)				
					})
				}
			}
