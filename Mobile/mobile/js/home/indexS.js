...
.factory('indexS', function($http,httpRequest){
	return {
		getBanner:function (callback) {
			$http.post(interfaceURL.home.banner).success(function (data) {
				
				if (data.resCode=="SUCCESS") {
					callback&&callback(data.bannerList)
				};				
			})
			
		},
//		getBanners:function (callback) {
//			$http.post(interfaceURL.home.banners).success(function (data) {
//				
//				if (data.resCode=="SUCCESS") {
//					callback&&callback(data.bannerList)
//				};				
...
//			
//		},
		getBanners:function (data,callback) {
			httpRequest.post(interfaceURL.home.banners,data).success(function (data) {
				if (data.resCode=="SUCCESS") {
					callback&&callback(data)
				};					
			})
		},
		getRoutes:function (data,callback) {
			httpRequest.post(interfaceURL.home.routes,data).success(function (data) {
				if (data.resCode=="SUCCESS") {
					callback&&callback(data)
				};			
			})
		},
		topNav:function (callback) {
			httpRequest.post(interfaceURL.home.topNav).success(function (data) {
				if (data.resCode=="SUCCESS") {
					callback&&callback(data)
				};			
			})
		...
		getHots:function (callback) {
			httpRequest.post(interfaceURL.home.hots).success(function (data) {
				if (data.resCode=="SUCCESS") {
					callback&&callback(data)
				};			
			})
		...
		activity:function (data,callback) {
			httpRequest.post(interfaceURL.coupon.activity,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		getMsg:function (data,callback) {
			httpRequest.post(interfaceURL.msgPush.msgPush,data).success(function (data) {
				callback&&callback(data)				
			})
		}
	}
