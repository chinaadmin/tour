...
.factory('activitywwS', function($http,httpRequest){
	return {
		...
		activityAward:function (data,callback,fail) {
			httpRequest.post(interfaceURL.activitys.activityAward,data).success(function (data) {
				callback&&callback(data)				
			}).error(function(e) {
				fail&&fail()
			});
		},
		activityHelpCode:function (data,callback) {
			httpRequest.post(interfaceURL.activitys.activityHelpCode,data).success(function (data) {
				callback&&callback(data)				
			})
		},
