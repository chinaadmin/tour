...
.factory('orderS', function(httpRequest){
	return {
		...
		addinvoice:function (data,callback) {
			httpRequest.post(interfaceURL.user.addinvoice,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		submitInfo:function (data,callback) {
			httpRequest.post(interfaceURL.promotion.submitInfo,data).success(function (data) {
				callback&&callback(data)				
			})
		}
	}
...
.factory('invoiceS', function(httpRequest){
	return {
		...
		add:function (data,callback) {
			httpRequest.post(interfaceURL.invoice.add,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		update:function (data,callback) {
			httpRequest.post(interfaceURL.invoice.update,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		del:function (data,callback) {
			httpRequest.post(interfaceURL.invoice.del,data).success(function (data) {
				callback&&callback(data)				
			})
		}
	}
