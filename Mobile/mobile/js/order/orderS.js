...
.factory('orderS', function(httpRequest){
	return {
		...
		orderDetail:function (data,callback) {
			httpRequest.post(interfaceURL.order.orderDetail,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		accountPay:function (data,callback) {
			httpRequest.post(interfaceURL.order.accountPay,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		get_info:function (data,callback) {
			//data.source = 1;
			httpRequest.post(interfaceURL.commodity.goodsInfo,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		getInsurance:function (data,callback) {
			//data.source = 1;
			httpRequest.post(interfaceURL.order.getInsurance,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		getDiscountPrice:function (data,callback) {
			//data.source = 1;
			httpRequest.post(interfaceURL.order.getDiscountPrice,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		availableIntegral:function (data,callback) {
			//data.source = 1;
			httpRequest.post(interfaceURL.order.availableIntegral,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		getinvoice:function (data,callback) {
			//data.source = 1;
			httpRequest.post(interfaceURL.order.getinvoice,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		getrecaddress:function (data,callback) {
			//data.source = 1;
			httpRequest.post(interfaceURL.order.getrecaddress,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		single:function (data,callback) {
			httpRequest.post(interfaceURL.order.single,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		refund:function (data,callback) {
			httpRequest.post(interfaceURL.order.refund,data).success(function (data) {
				callback&&callback(data)				
			})
		},
		...
		shipmentPrice:function (data,callback) {
			httpRequest.post(interfaceURL.order.shipmentPrice,data).success(function (data) {
				callback&&callback(data)				
			})
		}
	}
