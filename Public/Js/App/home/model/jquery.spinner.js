	...
	;(function ($) {
		...
		$(document).ready(function(){
		  ...
		  $.fn.decorateIframe = function(options) {
            ...
            //add by wxb 2014/7/14
		    $("#imageMenu li img").bind("click mouseover", function(){
		    ...
		    function fixedPosition(e) {
		        ...
		        if ($viewImgWidth == null) {
		            ...
		            if ($viewImgWidth < 320 || $viewImgHeight < 320) {
		                $viewImgWidth = $viewImgHeight = 960;
		            }
		        ...
		        $("#bigView").css({ "top": 0, "left": 32 + $(".preview").width() + 15 });
