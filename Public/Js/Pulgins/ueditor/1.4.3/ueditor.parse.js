...
UE.parse.register('vedio',function(utils){
    ...
    if(video.length || audio.length){
        var sourcePath = utils.removeLastbs(this.rootPath),
            jsurl = sourcePath + '/third-party/jwplayer/jwplayer.js';
            jwurl = sourcePath + '/third-party/jwplayer/jwpsrv.js';
            utils.loadFile(document,{
                 src : jsurl,
                 tag : "script",
                 type : "text/javascript"
            ...
            utils.loadFile(document,{
            	...
            	var videos = video || audio;
            	var length = videos.length;
            	for(i=0;i<length;i++){
            		var file = videos[i].getAttribute('src');
            		jwplayer(id).setup({
            			file: file,
            			autostart: 'true',
            		});
